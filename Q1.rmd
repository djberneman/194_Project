...
for(i in 1:1153){
  ...
  while(x <= 12){
    ...
    x = x + 1}
  month_12$LC_add[i] = sum1
  month_12$FIXED_add[i] = sum2
  month_12$LC_mult[i] = mult1
  month_12$FIXED_mult[i] = mult2
  avg1 = sum1/12
  avg2 = sum2/12
  cmpd1 = (1+avg1)^12-1
  cmpd2 = (1+avg2)^12-1
  month_12$LC_avg[i] = cmpd1
  month_12$FIXED_avg[i] = cmpd2}
